...
import com.judedevs.translatorapp.R
...
actual class UILanguage(
    ...
    actual companion object {
        actual fun byCode(langCode: String): UILanguage {
            return allLanguages.find { it.language.langCode == langCode } ?: throw IllegalArgumentException("Language with code $langCode not found")
        }
