package com.judedevs.translatorapp.android.voice_to_text.data
...
import com.judedevs.translatorapp.core.domain.util.CommonMutableStateFlow
import com.judedevs.translatorapp.core.domain.util.CommonStateFlow
import com.judedevs.translatorapp.core.domain.util.toCommonMutableStateFlow
...
import com.judedevs.translatorapp.voice_to_text.domain.VoiceToTextParserState
...
class AndroidVoiceToTextParser(
    ...
    override fun startListening(languageCode: String) {
        ...
        if(!SpeechRecognizer.isRecognitionAvailable(app)) {
            _state.update { it.copy(error = app.getString(R.string.error_speech_recognition)) }
            return
        }
    ...
    override fun onRmsChanged(rmsDb: Float) {
        // Normalize value before updating
